...
- OmniRoute cost-first policy metrics live under `dynamic_policy_route_attempts_total` (route class) and `dynamic_policy_escalations_total` (closed escalation reason). Durable task routing evidence remains the audit source.
